      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Understanding Your Needs</h2>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2"> Discover Your Vibe</h4>
              <p className="text-lg text-gray-400 text-center">Discover places  based on your preferences and vibe.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Venue Directory </h4>
              <p className="text-lg text-gray-400 text-center">Access a comprehensive directory of all venues in one place, making it convenient to explore and discover new spots.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Venue Booking</h4>
              <p className="text-lg text-gray-400 text-center">
              Users can easily book tables or reserve spots at their favorite venues directly through the app.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Party Discovery</h4>
              <p className="text-lg text-gray-400 text-center">Discover multiple parties and events happening around the area, ensuring users never miss out on the vibrant nightlife scene.</p>
            </div>
